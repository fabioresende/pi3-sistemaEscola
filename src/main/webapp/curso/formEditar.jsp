    ...
    <div class="container">
      ...
      <form method="post" name="myform" class="form-horizontal" 
      	...
      	<div class="form-group">
      		<label class="col-sm-2 control-label" for="codCurso">Código:</label>
      		<div class="col-sm-5">
      			<input type="text" name="codCurso" id="codCurso" value="${item.codCurso}" required="required" readonly="readonly" class="form-control"/>
      		</div>
      	</div>
